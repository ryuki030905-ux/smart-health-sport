...
PulseNova 是一个面向个人健康管理场景的智能运动健康 AI 助手项目，用于展示完整的软件工程能力，包括业务系统开发、数据可视化、权限控制，以及 AI 健康建议集成。项目以“健康记录 + 运动管理 + 饮食分析 + AI 辅助建议”为核心

## 项目定位

PulseNova 不是单纯的 CRUD 管理系统，而是一个围绕真实健康管理场景构建的综合应用。系统覆盖用户登录鉴权、健康档案、运动记录、饮食记录、统计图表、管理员后台，以及基于大模型和知识库检索的 AI 健康助手。

仓库当前以 **项目展示** 为主要目标，强调架构完整性、功能闭环和技术亮点
